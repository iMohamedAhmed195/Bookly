...
class Items extends BookEntity {
  ...
  Items(
      ...
      : super(
            ...
            authorName: volumeInfo.authors?.first ?? 'No Namae',
            price: 0.0,
...
class ListPriceBook {
  ...
  ListPriceBook({this.amount, this.currencyCode});

  ListPriceBook.fromJson(Map<String, dynamic> json) {
    amount = json['amount'];
